...
if(isset($_REQUEST['requpdate'])){
    ...
    "") || ($_REQUEST['course_desc'] == "") || ($_REQUEST
    ['course_author'] == "") || ($_REQUEST['course_duration'] == "") || ($_REQUEST['course_price'] == "") || ($_REQUEST
    ['course_original_price'] == "")){
        ...
        $cimg = '../image/Pic/'. $_FILES['course_img']['name'];

        $sql = "UPDATE course SET course_id = '$cid', course_name =
        '$cname', course_desc = '$cdesc', course_author = '$cauthor',
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="course_desc" id="course_desc" row=2><?php if(isset($row['course_desc'])
        ...
        <div class="form-group">
            <label for="course_original_price">Course Selling Price</label>
        ...
        <div class="form-group">
            ...
            <img src="<?php if(isset($row['course_img'])) {echo $row
            ['course_img']; } ?>" alt="" class="img-thumbnail">
