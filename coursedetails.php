...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-4">
            <img src="image/Pic/Guitar.jpg" class="card-img-top" alt="Guitar">
        </div>
        <div class="col-md-8">
            <div class="card-body">
                ...
                <form action="" method="post">
                    <p class="card-text d-inline">Price: <small><del>&#8377 2000</del></small> <span class="font-weight-bolder">&#8377
                    200</span></p>
